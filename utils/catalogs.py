"""Closed domain catalogs shared across phase boundaries."""
...
DELIVERABLE_KINDS = {"memo", "draft", "redline", "tracker", "checklist", "schedule", "calculation", "issue-list", "negotiation-plan"}
RIGHTS_USES = {"ingest", "transform", "train", "evaluate", "share", "publish"}
